                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_61485886f2f90" data-allow-clear="true">
                                                <option></option>
                                ...
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                data-placeholder="Select option"
                                                data-dropdown-parent="#kt_menu_6148588700dd8" data-allow-clear="true">
                                                <option></option>
                                                <option value="1">Approved</option>
                                                <option value="2">Pending</option>
                                                <option value="2">In Process</option>
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                <div class="symbol-label"
                                    style="
                                background-image: url('assets/media/stock/600x400/img-20.jpg');
                              ">
                                </div>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                <div class="symbol-label"
                                    style="
                                background-image: url('assets/media/stock/600x400/img-19.jpg');
                              ">
                                </div>
                            </div>
                            <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                <div class="flex-grow-1 me-2">
                                    <a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Yellow
                                        Background</a>
                                    <span class="text-muted fw-bold d-block pt-1">Size:
                                        1.2MB</span>
                                </div>
                        ...
                        <div class="d-flex align-items-sm-center mb-7">
                            ...
                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                <div class="symbol-label"
                                    style="
                                background-image: url('assets/media/stock/600x400/img-25.jpg');
                              ">
                                </div>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex align-items-sm-center">
                            ...
                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                <div class="symbol-label"
                                    style="
                                background-image: url('assets/media/stock/600x400/img-24.jpg');
                              ">
                                </div>
                            </div>
                            <!--end::Symbol-->
